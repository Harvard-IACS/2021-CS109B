...
Topics include big data, multiple deep learning architectures such as CNNs, RNNs, language models, transformers, autoencoders, and generative models as well as basic Bayesian methods, nonlinear statistical models, and unsupervised learning.
...
<mark>Lectures, sections, and advanced sections will be live-streamed and can be accessed through the Zoom section on Canvas. </mark>
...
Exercises will only be factored into your grade if the would improve your final grade.
...
All course materials, including lecture notes, lab notes, and section notes will be published on the <a href="https://github.com/Harvard-IACS/2021-CS109B/tree/master/content">course GitHub repo</a> as well as the public site's <a href="https://harvard-iacs.github.io/2021-CS109B/pages/materials.html">Materials section</a>.
<br/>
...
You are welcome to audit this course. To request access, send an email to cs109b2021@gmail.com with you HUID (required) and a statment of agreement to the terms below.
